...
function refineTemplateFields(
  ...
  const examples = data.variable_examples ?? {};
...
export const createTemplateSchema = templateFieldsSchema.superRefine(
...
export const updateTemplateSchema = templateFieldsSchema
  ...
  .superRefine(refineTemplateFields);
